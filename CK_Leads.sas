...
%LET APPFILE_LOC = 
"\\rmc.local\dfsroot\Dept\Marketing\Analytics\DigItal\Credit Karma\Input Lead and App Files\CreditKarma626.xlsx";
%LET CK_OUTPUT = 
...
DATA MERGE1;
	...
	*** AS APPROVED HERE. TASKSTATUS OF PENDING APPROVAL --------- ***;
	...
	IF LoanNumber NOT IN ('NULL', '') THEN IS_FUNDED = 1; 
...
PROC EXPORT 
	DATA = LAST 
	OUTFILE =  "&CK_OUTPUT\CreditKarma_Regional_06262018_test.csv"
	DBMS = CSV
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = SUMMARY 
	OUTFILE = "&CK_SUMMARY\CKRPT_06262018_test.xlsx" 
	REPLACE ;
RUN;
