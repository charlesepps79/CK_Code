...
%LET TCI_LOC = 
"\\rmc.local\dfsroot\Dept\Marketing\Analytics\DigItal\Credit Karma\Input Lead and App Files\Credit Karma Leads 20180630 MTHEND.xlsx";
%LET APPFILE_LOC = 
"\\rmc.local\dfsroot\Dept\Marketing\Analytics\DigItal\Credit Karma\Input Lead and App Files\ck_app_data_20180702.xlsx";
%LET CK_OUTPUT = 
...
DATA APPS;
	SET APPFILE; /* FORMAT FUNDEDATE yymmddd10. */
...
DATA LAST(
	KEEP = CK_TRACKING_ID LEADDATE APPLICATIONENTERDATE FUNDEDATE 
	...
	FORMAT CK_TRACKING_ID LEADDATE APPLICATIONENTERDATE FUNDEDATE
		   ISPQAPP IS_PREQUAL IS_APPL IS_APPROVE IS_FUNDED AMT_APPLIED 
		   AMT_APPROVED TERM_APPROVED RATE_APPROVED AMOUNT_FUNDED 
		   TERM_FUNDED RATE_FUNDED;
...
PROC EXPORT 
	DATA = LAST 
	OUTFILE =  "&CK_OUTPUT\CreditKarma_Regional_07022018.csv"
	DBMS = CSV
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = SUMMARY 
	OUTFILE = "&CK_SUMMARY\CKRPT_07022018.xlsx" 
	REPLACE ;
RUN;
